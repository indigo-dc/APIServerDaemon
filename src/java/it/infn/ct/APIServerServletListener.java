...
public class APIServerServletListener implements ServletContextListener {
	...
	// Notify execution
	System.out.println("--- " + "Starting APIServerDaemon " + System.getProperty("APISrvDaemonVersion") + " ---");
	...
	if (log4PropFile.exists()) {
	    ...
	    System.err.println(
		    "WARNING: '" + log4jPropPath + "' file not found, so initializing log4j with BasicConfigurator");
	...
	String pools[] = { "jdbc/fgApiServerPool", "jdbc/UserTrackingPool", "jdbc/gehibernatepool" };
