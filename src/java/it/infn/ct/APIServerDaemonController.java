 ...
 */
public class APIServerDaemonController extends Observable 
                                       implements Runnable {
    /*
    ...
    */    
    ...
    public void setConfig(APIServerDaemonConfig asdConfig) {
        ...
        _log.info("APIServerDaemon config:"                                   +LS
           +"  [Database]"                                                 +LS
           ...
           +"    ControllerDelay      : '"+this.asControllerDelay      +"'"+LS
            ...
            try {
                ...
                */
                asdDB= new APIServerDaemonDB( apisrv_dbhost
                                             ...
                                             ,apisrv_dbpass
                                             ,apisrv_dbname);
                List<APIServerDaemonCommand> 
                    commands = asdDB.getControllerCommands(asControllerMaxCommands);
                _log.debug("Received "
                          +commands.size()+"/"+asControllerMaxCommands
                          +" controller commands");
                /*
