 ...
 * @author <a href="mailto:riccardo.bruno@ct.infn.it">Riccardo Bruno</a>(INFN)
 */
@WebServlet(name = "GridEngineDaemonServlet", urlPatterns = {"/GridEngineDaemon"})
public class GridEngineDaemonServlet extends HttpServlet {
    ...
    */
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet GridEngineDaemonServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet GridEngineDaemonServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
