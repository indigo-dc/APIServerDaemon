    ...
    */
    ...
    public void setConfig(APIServerDaemonConfig asdConfig) {
        ...
        _log.info("APIServerDaemon config:"                                 +LS
                 ...
                 +"  [Polling config]"                                       +LS
                 +"    asPollingDelay  : '"    +this.asPollingDelay      +"'"+LS
            ...
            try {
                ...
                */
                ...
                List<APIServerDaemonCommand> 
                    commands = asdDB.getQueuedCommands(asPollingMaxCommands);
                _log.debug("Received "
                         +commands.size()+"/"+asPollingMaxCommands
                         +" waiting commands");
                /*
                ...
                */
                ...
                while (iterCmds.hasNext()) {
                    ...
                    APIServerDaemonProcessCommand asdProcCmd =
                        new APIServerDaemonProcessCommand(
                            asdCommand
